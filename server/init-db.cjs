...
// Disable foreign keys temporarily for initial data
...
VALUES (?, ?, ?)
`);
insertUser.run('default', 'default@localhost', 'Default User');

// Insert default project
const insertProject = db.prepare(`
INSERT OR IGNORE INTO projects (id, user_id, name, description, color)
VALUES (?, ?, ?, ?, ?)
`);
insertProject.run('default', 'default', 'My Project', 'Default project for organizing conversations', '#CC785C');
